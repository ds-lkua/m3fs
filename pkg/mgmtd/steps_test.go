...
func TestCreateChainAndTargetModelSuite(t *testing.T) {
	suiteRun(t, &createChainAndTargetModelSuite{})
}

type createChainAndTargetModelSuite struct {
	ttask.StepSuite
...
func (s *createChainAndTargetModelSuite) SetupTest() {
	s.StepSuite.SetupTest()
...
func (s *createChainAndTargetModelSuite) TestCreate() {
...
func (s *createChainAndTargetModelSuite) TestWithTargetStorServiceNotFound() {
	s.MockDocker.On("Exec", s.Cfg.Services.Mgmtd.ContainerName, "/opt/3fs/bin/admin_cli", []string{
		"--cfg", "/opt/3fs/etc/admin_cli.toml",
		`list-chains`,
	}).Return(`ChainId    ReferencedBy  ChainVersion  Status   PreferredOrder  Target                          Target
...
func (s *createChainAndTargetModelSuite) TestWithTargetDiskNotFoundForDirDiskType() {
	s.Runtime.Services.Storage.DiskType = config.DiskTypeDirectory
	s.MockDocker.On("Exec", s.Cfg.Services.Mgmtd.ContainerName, "/opt/3fs/bin/admin_cli", []string{
		"--cfg", "/opt/3fs/etc/admin_cli.toml",
		`list-chains`,
	}).Return(`ChainId    ReferencedBy  ChainVersion  Status   PreferredOrder  Target                          Target
...
func (s *createChainAndTargetModelSuite) TestWithTargetDiskNotFound() {
	s.MockDocker.On("Exec", s.Cfg.Services.Mgmtd.ContainerName, "/opt/3fs/bin/admin_cli", []string{
		"--cfg", "/opt/3fs/etc/admin_cli.toml",
		`list-chains`,
	}).Return(`ChainId    ReferencedBy  ChainVersion  Status   PreferredOrder  Target                          Target
